...
import { YesNoDialogComponent } from '../dialogs/yes-no-dialog/yes-no-dialog.component' // Ajusta o caminho se necessário
...
export class LoanCardComponent{
  ...
  isAdmin = input<boolean>(false); // Por defeito, não é admin
  ...
  onReturn() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result === true) {
        ...
        // Faz o pedido ao Backend para devolver o livro
